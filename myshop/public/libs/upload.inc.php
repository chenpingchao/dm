...
class upload1{
    public $upload_dir='11upload';
    public $max_size=1048576;
    public $type=['png','gif','jpg','jpeg'];
    public $is_img=true;

    //构造函数
   // public function __construct($upload_dir='11upload',$max_size=1048576,$type=['png','gif','jpg','jpeg'],$is_img=true){
