...
<div class="main">
    ...
    <form action="memberAction.php?act=changepwd" method="post" id="form1">
	<table cellpadding="0" cellspacing="0" width="100%">
    	...
    	<tr>
            ...
            <td class="pwd"><input type="password" name="newpwd" /></td>
        </tr>
    	<tr>
    	...
    	<tr>
            <td colspan="2"><a href="#" onclick="document.getElementById('form1').submit()" class="btns">保存</a></td>
        </tr>
    </table>
    </form>
</div>
